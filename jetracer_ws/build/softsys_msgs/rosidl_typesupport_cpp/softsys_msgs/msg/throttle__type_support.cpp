...
static const _Throttle_type_support_symbol_names_t _Throttle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, softsys_msgs, msg, Throttle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, softsys_msgs, msg, Throttle)),
  }
};
...
{
  return &::softsys_msgs::msg::rosidl_typesupport_cpp::Throttle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, softsys_msgs, msg, Throttle)() {
  return get_message_type_support_handle<softsys_msgs::msg::Throttle>();
}
